...
public class Planeta {
	...
	private String _cor;
	private int _diâmetro;
	private Regime _regime;
	private String _cidadeCapital;
	
	public Planeta(String _nome, Sistema _sistema, String _cor, int _diâmetro, Regime _regime, String _cidadeCapital) {
		super();
		this._nome = _nome;
		this._sistema = _sistema;
		this._cor = _cor;
		this._diâmetro = _diâmetro;
	...
	public int get_diâmetro() {
		return _diâmetro;
	}
	public void set_diâmetro(int _diâmetro) {
		this._diâmetro = _diâmetro;
	}
